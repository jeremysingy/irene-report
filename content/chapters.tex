...
To detect them properly, a property which differs in parts representing cracks and normal part of a record must be found. This part will be explained in the next subsection. Then, the different image processing algorithms needed will be detailed.

\subsection{Property of cracks}

The exact parameters will also depend on the different medium types.
\todo{End section}
