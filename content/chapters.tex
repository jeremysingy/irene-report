...
%TODO
%Another big issue, while tracking manually a record, is to 
...
%\section{Summary}
%
%Though the manual tracking is not the desired solution in most cases, it could the only possible solution in extreme or singular situation, as with a lot of damage or for a particular type of record.
%
%The new features enable then to simplify the manual tracking. The interactive tracking TODO... The grooves indication TODO.
