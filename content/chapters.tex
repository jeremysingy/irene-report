...
The Edison phonograph uses a groove that undulates vertically. However, a lot of records, particularly the discs, use laterally modulated grooves. It is no more the depth that determines the signal, but rather the lateral position of the bottom of the groove. The difference can be clearly seen in \autoref{fig:groovesdiff}.
...
This chapter gives an idea of the phonograph history and different devices, showing the heterogeneous nature of the audio recording, with a lot of different techniques and materials.
...
In fact, the camera yy shows the image zoomed out of 
